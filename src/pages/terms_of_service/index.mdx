...
However, **we have rights to temporarily forbid** Limited & Restricted fanart from gamers & contributors based on other contributors whose ages are less than mature. **This forbid only last until** contributors has finally reached their biologically mature birthday + 18 days after.
After which following date, no related forbid shall be reapplied furthermore.
Note: there are a chance that some not yet eligible contributors allows Limited & Restricted fanart at least on certain specification, for your safety, we suggest gamers to **avoid using such assets for those 2 scales at the moment** until at the time of contributor's statement, they've grown to eligible state + 18 days after.
