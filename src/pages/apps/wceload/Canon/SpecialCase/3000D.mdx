...
- Reattempt porting ML.
    ...
    - okay, just the 200D ones ironically does not work. [log](/assets/txt/logs/attemp_ml_2022-11-19_16-37/simplie_make_zip_again_again_log). Dude, what did make yours work? Think I should make issue [over there](https://github.com/reticulatedpines/magiclantern_simplified/issues)?
