...
- [Prepare QEMU](https://foss.heptapod.net/magic-lantern/magic-lantern/-/blob/branch/qemu/contrib/qemu/README.rst ).
    ...
    - [**QEMU COMPILE WORKS!!!**....](/assets/txt/logs/attempt_ml_2022-11-25/finally_qemu_sort_of_work.log) right? I need the dumped ROM to test it out.
    ...
    - [& vboxguest working](/assets/txt/logs/attempt_ml_2022-11-25/install_guest_addition.log). Damn, I'm sorry I have lost the URL where article tutorial is from.
