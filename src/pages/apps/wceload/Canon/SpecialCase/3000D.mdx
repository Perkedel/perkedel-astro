...
- [Prepare QEMU](https://foss.heptapod.net/magic-lantern/magic-lantern/-/blob/branch/qemu/contrib/qemu/README.rst ).
    ...
    - [`dos2unix`-ify suggestion overruled](https://www.magiclantern.fm/forum/index.php?topic=20214.msg241007#msg241007 ). It edits the file & would risk messing further commits (compare & stuffs) to upstream.
