...
-- `wget https://perkedel.netlify.app/MCCC_DL-startup_NyanCatMonitors.lua startup.lua`

downloadThisFile = 'https://perkedel.netlify.app/assets/scripts/lua/MCCC_Random_NyanCatMonitors.lua'
appName = 'Nyan Cat Monitors'
